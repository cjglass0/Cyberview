...
public class RepairRoomCutscene : MonoBehaviour
{
    ...
    IEnumerator CollectedGun()
    {
        ...
        dialogueHandler.showDialogue(AvatarShown.PROGAGONIST, "Alright, I have a gun now. I really don't want to use it, but if I have to, I'll at least have something to protect myself.");
